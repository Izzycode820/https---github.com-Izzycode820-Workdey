...
class SavedJobsService {
 ...
 /* // Add to your JobService class
Future<List<Job>> getJobsByIds(List<int> jobIds) async {
  try {
    ...
    throw Exception('Failed to fetch jobs by IDs: ${e.message}');
  }
}
...
Future<Job> getJobById(int jobId) async {
  try {
    ...
    throw Exception('Failed to fetch job $jobId: ${e.message}');
  }
}*/
}
