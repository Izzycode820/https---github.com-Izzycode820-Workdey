...
mixin _$User {
  ...
  Map<String, dynamic>? get verificationStatus =>
...
class _$UserImpl extends _User {
  ...
  @JsonKey(name: 'verification_status')
  Map<String, dynamic>? get verificationStatus {
    final value = _verificationStatus;
    if (value == null) return null;
    if (_verificationStatus is EqualUnmodifiableMapView)
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, phone: $phone, firstName: $firstName, lastName: $lastName, verificationStatus: $verificationStatus, profilePicture: $profilePicture)';
  }
