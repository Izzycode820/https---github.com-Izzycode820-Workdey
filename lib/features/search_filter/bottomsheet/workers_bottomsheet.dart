...
void showWorkerCategoryBottomSheet(BuildContext context, WidgetRef ref) {
  final currentCategory = ref.watch(workerSearchNotifierProvider.select((s) => s.category));
...
void showWorkerAvailabilityBottomSheet(BuildContext context, WidgetRef ref) {
  final currentAvailability = ref.watch(workerSearchNotifierProvider.select((s) => s.availability));
...
void showWorkerSkillsBottomSheet(BuildContext context, WidgetRef ref) {
  final currentSkills = ref.watch(workerSearchNotifierProvider.select((s) => s.skills));
...
void showWorkerLocationBottomSheet(BuildContext context, WidgetRef ref) {
  final currentLocation = ref.watch(workerSearchNotifierProvider).location;
