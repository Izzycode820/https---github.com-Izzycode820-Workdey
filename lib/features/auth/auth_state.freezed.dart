...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AuthResponse response) authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AuthResponse response)? authenticated,
...
class _$AuthenticatedImpl implements _Authenticated {
  const _$AuthenticatedImpl(this.response, {final String? $type})
...
abstract class _Authenticated implements AuthState {
  const factory _Authenticated(final AuthResponse response) =
      _$AuthenticatedImpl;
